...
export const mockProducts: Product[] = [
  {
    ...
    description: "Sofá com tecido premium, ótimo para sala moderna e muito conforto diário.",
    price: 1299,
    status: "DISPONIVEL",
    imageUrl:
  ...
  },
  {
    ...
    description: "Performance para estudo, trabalho e diversão com boa placa de vídeo e SSD rápido.",
    price: 2899,
    status: "RESERVADO",
    imageUrl:
  ...
  },
  {
    ...
    description: "Modelo leve, confortável e ideal para deslocamentos diários com estilo urbano.",
    price: 899,
    status: "DISPONIVEL",
    imageUrl:
